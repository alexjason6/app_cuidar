...
export default function assistenciaMotos() {
  return (
    <ScrollView style={styles.containerRegulamentos}>
      <Text style={styles.titleRegulamento}>
        REGULAMENTO benefício ASSISTÊNCIA MOTOS STANDARD
      </Text>
      ...
      <Text style={styles.conteudoRegulamento}>
        É toda moto, com mais de 150 (cento e cinqüenta) cilindradas, de
        qualquer marca ou modelo e com até 12 (doze) anos de idade.
      </Text>
      <View style={{height: 30}} />
      <Text style={styles.titleRegulamento}>
      ...
      <Text style={styles.conteudoRegulamento}>
        Em caso de acidente, roubo, pane ou incêndio, a Assistência
        providenciará o envio de um mecânico para conserto de emergência no
        local, se tecnicamente possível, até um raio de 100 km. As despesas com
        a reposição de peças necessárias para o conserto correrão por conta do
        Cliente, responsabilizando-se a Assistência somente pelo custo da
        mão-de-obra e deslocamento do socorro mecânico. Este serviço garante
        apenas um reparo provisório, sendo que caberá ao Cliente conduzir o
        veículo imediatamente a uma oficina de sua escolha para definitivo
        reparo, ficando os serviços de oficina, como reposição de peças, sob sua
        responsabilidade. Limite: 01 (uma) utilização/mês.
      </Text>
      ...
      <Text style={styles.conteudoRegulamento}>
        ...
        rebocado até uma oficina num raio máximo de ação de 100 (cem)
        quilômetros ou até a oficina referenciada mais próxima. Plano Standard:
        Limitado ao raio máximo de 150 (cento e cinquenta quilômetros). Limite:
        01 (uma) utilização/mês.
      </Text>
      ...
      <Text style={styles.conteudoRegulamento}>
        ...
        será rebocado até uma oficina num raio máximo de ação de 100 (cem)
        quilômetros ou até a oficina referenciada mais próxima. Limite: 01 (uma)
        utilização/mês.
      </Text>
      ...
      <Text style={styles.conteudoRegulamento}>
        ...
        enviado um prestador de serviços para efetuar a remoção do veículo até a
        oficina mais próxima, em um raio máximo de 100 (cem) km. OBS.: O custo
      ...
      <Text style={styles.conteudoRegulamento}>
        ...
        decisão tomada pela equipe médica da Assistência 24 horas, esta não se
        responsabilizará por custos ou conseqüências. O limite financeiro é de
      ...
      <Text style={styles.conteudoRegulamento}>
        Em caso de falecimento do Cliente ou de algum de seus acompanhantes
        devido a acidente com o veículo do Cliente, a Assistência 24 horas
        providenciará o traslado dos corpos para a cidade de sepultamento do
        cliente, limitadas às despesas de até R$ 1.500,00 (um mil e quinhentos
        reais) por óbito. Limite máximo de 2 (duas) pessoas.
      </Text>
      <Text style={styles.titleRegulamento}>
