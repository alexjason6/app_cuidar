...
export default function AssistenciaCarros() {
  return (
    <View>
      <Text title>ACIDENTE / SINISTRO</Text>
      <Text>
      ...
      <Text title>SOS ELÉTRICO / MECÂNICO</Text>
      <Text>
      ...
      <Text title>REBOQUE APÓS PANE</Text>
      <Text>
      ...
      <Text title>REBOQUE APÓS SINISTRO</Text>
      <Text>
      ...
      <Text title>TROCA DE PNEUS</Text>
      <Text>
      ...
      <Text title>SERVIÇO DE CHAVEIRO</Text>
      <Text>
      ...
      <Text title>MOTORISTA SUBSTITUTO</Text>
      <Text>
      ...
      <Text title>TRANSLADO DE CORPO</Text>
      <Text>
      ...
      <Text title>RETORNO A DOMICÍLIO</Text>
      <Text>
      ...
      <Text title>GUARDA DO VEÍCULO</Text>
      <Text>
